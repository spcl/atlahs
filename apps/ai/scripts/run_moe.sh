#!/bin/bash -l
#SBATCH --job-name="megatron-moe-pretrain"
...
MIN_GLOBAL_BATCH_SIZE=32
GLOBAL_BATCH_SIZE=$(((${MICRO_BATCH_SIZE}*${DP}) > ${MIN_GLOBAL_BATCH_SIZE} ? ${MICRO_BATCH_SIZE}*${DP} : ${MIN_GLOBAL_BATCH_SIZE}))
echo "Global batch size: ${GLOBAL_BATCH_SIZE}"
echo "Micro batch size: ${MICRO_BATCH_SIZE}"
# Network size variables
MODEL_SIZE=7

if   [[ ${MODEL_SIZE} == 7 ]];   then HIDDEN_SIZE=4096;  NUM_HEAD=32; NUM_QUERY_GROUP=8; NUM_LAYERS=32; FFN_HIDDEN_SIZE=14336; NORM_EPS=1e-5;
