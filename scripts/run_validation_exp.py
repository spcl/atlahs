...
def run_validation_exp(trace_dir: str, result_dir: str, simulator: str,
                       sim_config: str, exec: str, app_type: str,
...
if __name__ == '__main__':
    ...
    run_validation_exp(args.trace_dir, args.result_dir, args.simulator, args.config,
                       args.exec, args.app_type, args.overwrite, args.verbose)
    print_success("Validation experiment completed successfully.")
